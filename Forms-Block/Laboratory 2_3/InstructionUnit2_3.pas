...
begin
    Info.Caption :=
        '1. Введите размер квадратной матрицы (от 2 до 100).' + #13#10 +
        ...
        '4. Нажмите кнопку ''найти наибольшую сумму'', чтобы программа нашла'+ #13#10 +
        '    наибольшую суммую соседних элементов матрицы.' + #13#10 +
