...
Uses
    ...
    Vcl.ImgList, Vcl.Menus, Vcl.Grids, Vcl.Buttons, Vcl.ExtCtrls,
    Vcl.Imaging.Jpeg;
...
Uses AboutTheDeveloperUnit2_4, InstructionUnit2_4, ExitUnit2_4, BackendUnit2_4;
...
Begin
    ...
    Begin
        ...
        Begin
            If (Length(ElementsOfMatrix.Cells[J, I]) <> 0) And
                (ElementsOfMatrix.Cells[J, I] <> '-') Then
            Begin
                SumSearcher.SetElemtentOfMatrix
                    (StrToInt(ElementsOfMatrix.Cells[J, I]), I - 1, J - 1);
                Inc(Counter);
            End;
        End;
    End;
...
Begin
    ...
    MaxSumLabel.Caption := 'Наибольшая сумма равна: ' +
        IntToStr(SumSearcher.GetSum()) + #46;
...
Begin
    ...
    Begin
        ...
        Begin
            FileWriter.OutputSum(SumSearcher.GetSum());
