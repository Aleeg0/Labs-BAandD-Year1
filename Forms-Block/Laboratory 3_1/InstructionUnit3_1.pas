...
begin
    Info.Caption :=
        ...
        '2. Нажмите кнопку ''найти число'', чтобы программа нашла'+ #13#10 +
        '    число в данной строке.' + #13#10 +
        'Примечания: ' + #13#10 +
        '1) Программа находит число только, если оно начинается с ''+'' или ''-''.' + #13#10 +
