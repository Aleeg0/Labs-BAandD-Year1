...
public class MainMenu
{
    ...
    {
        Console.WriteLine("Программа находит значения вершин, у которых высота левого поддерева\nне равны высоте правого поддерева");
    }
    ...
    public void OutputShowMenu()
    {
        Console.WriteLine("Меню вывода:\n" +
                          "1. Вывести значение вершин деревьев;\n" +
                          "2. Записать значение вершин деревьев в файл.");
    }
}
